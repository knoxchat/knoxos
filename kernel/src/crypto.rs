...
/// RFC 8439 §2.3.2 ChaCha20 block known-answer test.
pub fn chacha20_rfc8439_kat() -> bool {
    let key: [u8; 32] = [
    ...
    // RFC 8439 §2.3.2 serialized block (little-endian words).
    let expected: [u8; 64] = [
    ...
    chacha20_block(&key, 1, &nonce) == expected
}
